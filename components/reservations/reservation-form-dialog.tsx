...
export function ReservationFormDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="w-[95vw] max-w-6xl max-h-[90vh] overflow-y-auto bg-slate-50/50 dark:bg-slate-950/50 backdrop-blur-sm p-4 md:p-6">
                <DialogHeader className="mb-4">
                    <DialogTitle className="text-2xl font-bold text-primary">
                        {reservation?.id ? 'Modifica Prenotazione' : 'Nuova Prenotazione'}
                    </DialogTitle>
                    <DialogDescription>
                        Gestisci i dettagli della prenotazione in modo completo
                    </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <Card className="border-l-4 border-l-blue-500 shadow-md">
                            ...
                            <CardContent className="pt-6 grid gap-4">
                                <div className="space-y-2">
                                    <Label htmlFor="customerName" className="font-semibold">Nome Cliente</Label>
                                    <Input
                                        id="customerName"
                        ...
                        <Card className="border-l-4 border-l-amber-500 shadow-md">
                            <CardHeader className="pb-3 bg-amber-50/50 dark:bg-amber-900/10">
                    ...
                    <Card className="border-l-4 border-l-green-500 shadow-md w-full">
                        ...
                        <CardContent className="pt-6 space-y-4">
                                    ...
                                    <Popover open={isDatePickerOpen} onOpenChange={setIsDatePickerOpen}>
                                        <PopoverTrigger asChild>
                                            <Button
                                                variant="outline"
                                                className={cn(
                                                    'w-full justify-start text-left font-normal bg-white dark:bg-slate-900',
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <div className="space-y-2 md:col-span-1">
                                    <Label htmlFor="numGuests">Coperti</Label>
                                    <Input
                                        id="numGuests"
                                        type="number"
                                        inputMode="numeric"
                                ...
                                <div className="space-y-2 md:col-span-2">
                                    <Label htmlFor="tableId">Tavolo</Label>
                                    <Select
                                        value={watchedTableId}
                                        onValueChange={(value) => setValue('tableId', value)}
                                    >
                                        <SelectTrigger id="tableId" className="bg-white dark:bg-slate-900">
