...
export function ReservationFormDialog({
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="w-full sm:w-[95vw] max-w-2xl h-[100dvh] sm:h-[85dvh] p-0 gap-0 flex flex-col bg-slate-50 dark:bg-black overflow-hidden border-0 sm:border rounded-none sm:rounded-xl">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col flex-1 min-h-0">
                    ...
                    <div className="p-4 pb-[max(1rem,env(safe-area-inset-bottom))] border-t bg-white dark:bg-black flex justify-end gap-3 shrink-0">
